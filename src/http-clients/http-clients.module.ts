...
import { NearRpcApiModule } from './near-rpc-api/near-rpc-api.module';

@Module({
    imports: [I18nServiceApiModule, OneClickApiModule, HyperliquidApiModule, SolverRelayApiModule, NearRpcApiModule],
    exports: [I18nServiceApiModule, OneClickApiModule, HyperliquidApiModule, SolverRelayApiModule, NearRpcApiModule],
})
